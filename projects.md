- [dot](https://github.com/iruzo/dot)                               Dotfiles
- [wp](https://github.com/iruzo/wp)                                 Wallpapers
- [snip](https://github.com/iruzo/snip)                             Snippets
- [sh](https://github.com/iruzo/sh)                                 Shells

---
apps
- [pxmenu](https://github.com/iruzo/pxmenu)                         POSIX sh simple menu
- [pxalarm](https://github.com/iruzo/pxalarm)                       POSIX sh simple alarm
- [pxrandr](https://github.com/iruzo/pxrandr)                       POSIX sh simple autorandr

---
libs
- [pfmenu](https://github.com/iruzo/pfmenu)                         Python simple fuzzy menu
- [history](https://github.com/iruzo/history_service)               Dart library with 3 simple functionalities that helps you manage any kind of history
...
---
wip
- [hibro](https://github.com/iruzo/hibro)                           C2 written in rust
- [catppuccin-wvkbd](https://github.com/iruzo/wvkbd)
- [catppuccin-darktile](https://github.com/iruzo/darktile)
- [catppuccin-fr33zmenu](https://github.com/iruzo/fr33zmenu)
